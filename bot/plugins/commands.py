...
from bot.jackey import MT_BOT_UPDATES
...
async def start(bot, update):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 👨‍💼', url="https://t.me/clause07"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        InlineKeyboardButton('👨‍💼Creater', url=f'https://t.me/clause07'),
        InlineKeyboardButton('Help 🤔', callback_data="help")
    ],[
        InlineKeyboardButton('🗣️Group', url=f'{MT_GROUP}'),
        InlineKeyboardButton('Channel🔊', url=f'{MT_CHANNEL}')
    ],[
        InlineKeyboardButton('🖥️ Assistant 🖥️', url='https://t.me/jackey_07')
    ]]
...
async def help(bot, update):
    ...
    await bot.send_message(
        ...
        reply_markup=reply_markup,
        parse_mode=enmus.ParseMode.HTML,
        reply_to_message_id=update.message_id
    )
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('👤 Owner👤', url='https://t.me/clause07'),
        InlineKeyboardButton('Helper👤', url='https://t.me/jackey_07')
    ],[
        InlineKeyboardButton('🥋 Bot Updates', url='https://t.me/AlbertEinsteinTG')
    ],[
